...
module.exports = class Product {
    ...
    delete() {
        getProductsFromFile(products => {
            ...
            if (existingProductIndex !== -1) {
                ...
                console.log('Deleted Product ID: ', existingProductIndex, products[existingProductIndex])
            } else {
    ...
    static findById(id, cb) {
        getProductsFromFile(products => cb(products.find(p => p.id == id)))
    }
}